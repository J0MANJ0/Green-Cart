        ...
        <div>
            <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all z-50">
                ...
                <div className="hidden sm:flex items-center gap-8">
                    <NavLink to='/' className='hover:underline text-2xl decoration-primary decoration-3'>Home</NavLink>
                    <NavLink to='/products' className='hover:underline text-2xl decoration-primary decoration-3'>All Products</NavLink>
                    <NavLink to='/' className='hover:underline text-2xl decoration-primary decoration-3'>Contact</NavLink>
                    ...
                    <div onClick={() => navigate('/cart')} className="relative cursor-pointer">
                        <img src={assets.nav_cart_icon} alt="cart" className="size-4" />
